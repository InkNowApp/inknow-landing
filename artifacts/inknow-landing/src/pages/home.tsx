    ...
    <div className="min-h-screen bg-[#0C0C0C] text-white overflow-x-hidden">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <a href="https://play.google.com/store/apps/details?id=com.inknow" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity">
              <img src={`${BASE}assets/badge-googleplay.png`} alt="Get it on Google Play" className="h-10 w-auto" />
            </a>
          </div>
        </div>
      </nav>
      ...
      <section className="py-28 px-6 bg-[#0a0a0a]">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-5">
            <ArtistCard name="Kylie Schneider" location="Ink District · Warren, OH" styles={["Realism", "Blackwork", "Piercing"]} rating={4.8} reviews={32} price="Contact for pricing" verified initials="KS" accent="bg-gradient-to-br from-zinc-800 to-zinc-900" />
            <ArtistCard name="Kontakt90" location="Independent · Atlanta, GA" styles={["Fine Line", "Geometric", "Minimalist"]} rating={5.0} reviews={12} price="$120/hr" verified initials="K90" accent="bg-gradient-to-br from-stone-800 to-zinc-900" />
            <ArtistCard name="B Sum Tatu" location="Studio 7 · Austin, TX" styles={["Traditional", "Watercolor", "Piercing"]} rating={5.0} reviews={8} price="$95/hr" verified initials="BST" accent="bg-gradient-to-br from-neutral-800 to-zinc-900" />
          </div>
      ...
      <section className="py-28 px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-white/20 text-xs mt-6">Free on iOS & Android</p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8 mb-10">
            ...
            <div className="flex items-center gap-4">
              <a href="https://www.instagram.com/inknowofficial?igsh=MmF1dDN3bG85bmtq&utm_source=qr" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full border border-white/10 flex items-center justify-center text-white/30 hover:text-white/60 hover:border-white/20 transition-all">
              ...
              <a href="https://www.tiktok.com/@inknowapp?_r=1&_t=ZP-98mf9UkVOBj" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full border border-white/10 flex items-center justify-center text-white/30 hover:text-white/60 hover:border-white/20 transition-all">
