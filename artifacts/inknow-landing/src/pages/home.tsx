    ...
    <div className="min-h-screen bg-[#0C0C0C] text-white overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4 border-b border-white/[0.06] bg-[#0C0C0C]/90 backdrop-blur-xl">
        ...
        <div className="flex items-center gap-3">
          ...
          <a
            href="https://play.google.com/store/apps/details?id=com.inknow"
          ...
          <div className="flex flex-col gap-6 z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-3 mt-2">
              ...
              <a
                href="https://play.google.com/store/apps/details?id=com.inknow"
                target="_blank" rel="noopener noreferrer"
                className="flex items-center justify-center gap-2.5 px-7 py-4 rounded-2xl border border-white/10 bg-white/[0.04] hover:bg-white/[0.08] text-white font-semibold text-base transition-all duration-200 hover:-translate-y-0.5"
              >
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor"><path d="M3.18 23.76c.3.17.65.19.98.07l13.49-7.79-2.97-2.97-11.5 10.69zM.5 1.1C.19 1.43 0 1.93 0 2.59v18.82c0 .66.19 1.16.51 1.49l.08.08L10.65 12.9v-.25L.58 1.02.5 1.1zm17.61 9.1-3.18-1.84-3.28 3.28 3.28 3.28 3.19-1.84c.91-.53.91-1.38-.01-1.88zm-17 12.56.08-.08 10.07-10.6v-.25L.59 1.02c-.04.04-.09.07-.08.1z"/></svg>
                Get on Android
              </a>
            </div>
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <a
              href="https://play.google.com/store/apps/details?id=com.inknow"
              target="_blank" rel="noopener noreferrer"
              className="flex items-center justify-center gap-2.5 px-8 py-4 rounded-2xl border border-white/10 bg-white/[0.04] hover:bg-white/[0.08] text-white font-semibold text-base transition-all duration-200 hover:-translate-y-0.5"
            >
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor"><path d="M3.18 23.76c.3.17.65.19.98.07l13.49-7.79-2.97-2.97-11.5 10.69zM.5 1.1C.19 1.43 0 1.93 0 2.59v18.82c0 .66.19 1.16.51 1.49l.08.08L10.65 12.9v-.25L.58 1.02.5 1.1zm17.61 9.1-3.18-1.84-3.28 3.28 3.28 3.28 3.19-1.84c.91-.53.91-1.38-.01-1.88zm-17 12.56.08-.08 10.07-10.6v-.25L.59 1.02c-.04.04-.09.07-.08.1z"/></svg>
              Get on Android
            </a>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8 mb-10">
            ...
            <div className="flex items-center gap-4">
              <a href="https://www.instagram.com/inknowapp?igsh=MWkycGgzeXg1MjBwbQ%3D%3D&utm_source=qr" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full border border-white/10 flex items-center justify-center text-white/30 hover:text-white/60 hover:border-white/20 transition-all">
